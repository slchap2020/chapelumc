...
if(isset($_GET['delete'])){
   ...
   if($delete_query){
      header('location: prayerpublisher.php');
...
if(isset($_POST['update_prayer'])){
 ...
 if($update_query){
      $message[] = 'prayer updated succesfully';
      header('location:prayerpublisher.php');
   }else{
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               ...
               <a href="prayerpublisher.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="update the prodcut" name="update_prayer" class="btn">
