...
<button class= "menubutton" onclick="document.location = 'prayerpublisher.php'">Prayer Request Updates</button>
...
<button class= "menubutton" onclick="document.location = 'publisherstaff.php'">Staff Updates</button>
<button class= "menubutton" onclick="document.location = 'products.php'">Shop</button>
<button class= "menubutton" onclick="document.location = 'publishershop.php'">Shop Updates</button>
<button class= "menubutton" onclick="document.location = 'forms.php'">Product Review </button>
<button class= "menubutton" onclick="document.location = 'publisherdatabase.php'">Staff Reviews </button>
