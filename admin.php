...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="text" name="p_description" min="0" placeholder="enter the product description" class="box" required>
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="admin.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a><br br>
